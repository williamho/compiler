a: bin/y.tab.o bin/lex.yy.o bin/expressions.o bin/symtable.o bin/declarations.o bin/statements.o bin/quads.o bin/globals.o bin/target.o
	gcc -g -o a bin/declarations.o bin/symtable.o bin/expressions.o bin/statements.o bin/quads.o bin/y.tab.o bin/lex.yy.o bin/globals.o bin/target.o
